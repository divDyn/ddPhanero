---
title: "Phanerozoic-scale global marine biodiversity analysis with the R package divDyn v0.6"
author: "Adam T. Kocsis, John Alroy, Carl J. Reddin, Wolfgang Kiessling"
date: '`r Sys.Date()`'
output: pdf_document
vignette: >
  %\VignetteIndexEntry{Phanerozoic-scale global marine biodiversity analyses with the R package divDyn v0.6}
...
```
and are referenced directly from the vignette. We intend to update this material for future reference. The analytical script presented here is also available as a regular .R file (scripts/2018-09-14_marineAnimals_ddPhanero.R).
...
```{r pulseCont, echo= TRUE, plot=TRUE, fig.height=5.5}
...
tsplot(stages,  boxes="per", shading="per", ylim=c(0, nMaxRate*1.05), ylab="Turnover rates", 
